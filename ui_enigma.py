...
class Ui_inputTextArea(object):
    ...
    def retranslateUi(self, inputTextArea):
        ...
        self.rotor3Model.setItemText(5, QCoreApplication.translate("inputTextArea", u"VI", None))
        self.rotor3Model.setItemText(6, QCoreApplication.translate("inputTextArea", u"VII", None))
        self.rotor3Model.setItemText(7, QCoreApplication.translate("inputTextArea", u"VIII", None))
        ...
        self.rotor1Model.setItemText(5, QCoreApplication.translate("inputTextArea", u"VI", None))
        self.rotor1Model.setItemText(6, QCoreApplication.translate("inputTextArea", u"VII", None))
        self.rotor1Model.setItemText(7, QCoreApplication.translate("inputTextArea", u"VIII", None))
        ...
        self.rotor2Model.setItemText(5, QCoreApplication.translate("inputTextArea", u"VI", None))
        self.rotor2Model.setItemText(6, QCoreApplication.translate("inputTextArea", u"VII", None))
        self.rotor2Model.setItemText(7, QCoreApplication.translate("inputTextArea", u"VIII", None))
